	...
	//File API 지원 여부로 결정 (다중파일업로드:드래그 방식)으로 변경하려면 else{bSupportDragAndDropAPI = false; 를 true로 변경한다 -규-
	...
	function onAjaxError (){
 	...
 	function callFileUploader (){
 		oFileUploader = new jindo.FileUploader(jindo.$("uploadInputBox"),{
 	        ...
 	        sCallback : '/resource/se/photo_uploader/popup/callback.html',	//업로드 이후에 iframe이 redirect될 콜백페이지의 주소
