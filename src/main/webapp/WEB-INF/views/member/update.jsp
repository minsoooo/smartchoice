...
<body style="background-color:#f5f4f0">
	...
	<div class ="container">
		<div class ="row">
			<div class = "span12">
					<font id ="id_font">ID  :  ${sessionScope.MEM_KEY.mem_id } </font><font id="email_font"> E-MAIL  :  ${sessionScope.MEM_KEY.mem_email }</font>
			</div>
		</div>
	</div>
	<div class="container">
...
<form id ="form" method ="post" action="/member/update">
	<div class ="container">
		<div class ="row">
