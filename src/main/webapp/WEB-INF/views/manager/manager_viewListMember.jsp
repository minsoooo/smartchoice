...
$(document).ready(
	...
	function goPage(page_num){
		location.href="/manager/manager_viewListMember?page_num="+page_num+"&keyword="+keyword+"&value="+value;
	}
...
<span id ="getKeyword" value ="${keyword }"></span>
	...
	<div class ="container">
		<div class ="row">
			<div class ="span12" id ="searchDiv">
				...
				<input type ="button" value ="전체보기" onclick ="fnViewAll()" id="btnAll"/>
			</div>
		</div>
	</div>
	<div class ="container">
